...
#
# Independent verifier for fault_id=python-dependency-05 (see meta.json).
# The fault is fixture-app-python's check_inventory() (inventory.py) no
# longer surfacing a non-200 downstream inventory response as a 503,
# instead forwarding its body under a 200. Checked against a real (mock)
...
INVENTORY_URL="http://127.0.0.1:${MOCK_PORT}" python3 server.py &
APP_PID=$!
