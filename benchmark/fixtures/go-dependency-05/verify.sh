...
#
# Independent verifier for fault_id=go-dependency-05 (see meta.json). The
# fault is fixture-app-go's handleInventoryCheck() (inventory.go) no longer
...
BIN="$(mktemp -t revi-verify-go-dependency-05-XXXXXX)"
