...
#
# Independent verifier for fault_id=go-badvalidation-07 (see meta.json).
# The fault is fixture-app-go's handleFormatOrder() (format.go) no longer
...
BIN="$(mktemp -t revi-verify-go-badvalidation-07-XXXXXX)"
