...
#
# Independent verifier for fault_id=go-discount-03 (see meta.json). The
# fault is fixture-app-go's handleBulkDiscount() (discount.go) using
...
BIN="$(mktemp -t revi-verify-go-discount-03-XXXXXX)"
